...
comments = false 
aliases = ["/20260511_barcelona_declaration_expands_steering_group"]
+++
...
Three new members have been appointed: **Daniela Perrotta** ([CLACSO](https://www.clacso.org/), the Latin American Council of Social Sciences), **Miranda Bennett** ([California Digital Library](https://cdlib.org/), part of the University of California), and **Beatrix Busse / Nicoleta Laura Popa** ([Coimbra Group](https://www.coimbra-group.eu/), an association of over 40 research-intensive multidisciplinary European universities).
...
This highlights that advancing open research information requires **aligned efforts across different levels**, from institutional practice and implementation to coordination across 
networks.
